...
# This variable will be set externally by your classifier
...
# def update_eye_action(action: str):
#     """Called by your Oculy classifier pipeline."""
#     last_eye_action = action
...
def run_game():
    ...
    while True:
        ...
        # ------------------------------
        if last_eye_action == "left":      # Maps to moving paddle LEFT
            paddle_x -= PADDLE_SPEED
        elif last_eye_action == "right":   # Maps to moving paddle RIGHT
            paddle_x += PADDLE_SPEED
        elif last_eye_action == "blink":
