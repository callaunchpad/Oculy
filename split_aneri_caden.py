"""Split combined aneri+caden data into 80/20 train/val using stratified segment-based approach."""
...
def main():
    data_path = Path("data/caden/v2/combined_aneri_caden_data.csv")
    labels_path = Path("data/caden/v2/combined_aneri_caden_labels.csv")
    output_dir = Path("splits/aneri_caden_combined")
    ...
    print(f"Sessions: {data_df['session_id'].unique().tolist()}")
    ...
    print("Segments by session:", session_counts)
