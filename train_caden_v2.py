"""Train 1D CNN on cleaned caden_v2 data with 1000-sample windows and segment mean padding."""
...
def train():
    ...
    train_csv = Path("splits/caden_v2_cleaned/train.csv")
    val_csv = Path("splits/caden_v2_cleaned/val.csv")
    output_dir = Path("models/caden_v2_cleaned")
    
    print("=" * 60)
    print("Training 1D CNN on Cleaned Caden V2 Data")
    print("=" * 60)
    print(f"Window length: {WINDOW_LENGTH}")
